    ...
    def nueva_maquinaria():
        if request.method == "POST":
            ...
            datos = {
                ...
                "nombre_mantenimiento": request.form.get("nombre_mantenimiento", ""),
                "voltaje": request.form.get("voltaje", ""),
                "departamento": request.form.get("departamento") or None,
                "serie_interna": request.form["id_activo"].replace("ACT-", "SN-", 1),
    ...
    def editar_maquinaria(id_activo):
        ...
        if request.method == "POST":
            datos = {
                ...
                "voltaje": request.form.get("voltaje", ""),
                "departamento": request.form.get("departamento") or None,
                "serie_interna": maquina.get("serie_interna") or id_activo.replace("ACT-", "SN-", 1),
                "proveedor": request.form["proveedor"],
                "ubicacion": request.form["ubicacion"],
